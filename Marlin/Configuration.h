...
#define STRING_CONFIG_H_AUTHOR "(marwatk, Ender-3)" // Who made the changes.
...
//Creality: #define BED_MAXTEMP 150
...
#define Z_PROBE_OFFSET_FROM_EXTRUDER -1.80   // Z offset: -below +above  [the nozzle]
